...
class MPesaResponseCode
{
    ...
    const TRANSACTION_CANCELLED_BY_CUSTOMER = "INS-5";
    ...
    const INVALID_TRANSACTION_REFERENCE     = "INS-17";
    const INVALID_TRANSACTION_ID      = "INS-18";
    const INVALID_THIRD_PARTY_REFERENCE     = "INS-19";
    ...
    const INVALID_SECURITY_CREDENTIAL = "INS-25";
    const NOT_AUTHORIZED              = "INS-26";
    const DIRECT_DEBIT_MISSING        = "INS-993";
    const DIRECT_DEBIT_EXISTS         = "INS-994";
    const CUSTOMER_PROFILE_PROBLEM    = "INS-995";
    const CUSTOMER_ACCOUNT_NOT_ACTIVE = "INS-996";
    const LINKING_TRANSACTION_NOT_FOUND = "INS-997";
